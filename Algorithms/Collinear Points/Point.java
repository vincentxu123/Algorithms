...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        /* YOUR CODE HERE */
    	double xcor = that.x - this.x;
    	double ycor = that.y - this.y;
    	if (xcor == 0 && ycor == 0) {
    ...
    private static class BySlope implements Comparator<Point> {
		...
		public int compare(Point o1, Point o2) {
			if (one.slopeTo(o1) < one.slopeTo(o2)) {
				return -1;
			} else if (one.slopeTo(o1) > one.slopeTo(o2)) {
				return 1;
			} else {
				return 0;
			}
    ...
    public static void main(String[] args) {
    	...
    	point[4] = new Point(0,1);
    	point[5] = new Point(1,2);
    	point[6] = new Point(2,3);
    	point[7] = new Point(3,4);
    	point[8] = new Point(4,4);
    	
    	BruteCollinearPoints brute = new BruteCollinearPoints(point);
    	System.out.println(brute.numberOfSegments());
    	//LineSegment[] arr = brute.segments();
//    	FastCollinearPoints fast = new FastCollinearPoints(point);
//    	LineSegment[] arr = fast.segments();
